            ...
            children: [   
              ...
              ElevatedButton(
                onPressed: () async{   
                  ...
                  AcadmicRate obj = AcadmicRate(rateID, studID!,generalRate, comment, attent_fast_resp, support_direct, rules_know);
                  await FirebaseFirestore.instance.collection('ratings').doc(widget.advisorUid).collection("advisor_ratings").add(obj.toJson()).then((result) { 
